...
#define NMETA   2 
#define NBLOCKS 1000 
#define LOGSTART   (NMETA)
#define INODESTART (LOGSTART + NLOG)
#define IPB        (BSIZE / sizeof(struct dinode))
#define IBLOCK(i, sb) ((i) / IPB + sb.inodestart)
#define NINODEBLOCKS (NINODES / IPB + 1)
#define BMAPSTART  (INODESTART + NINODEBLOCKS)
#define BPB        (BSIZE * 8)
#define NBITMAPBLOCKS ((NBLOCKS / BPB) + 1)
#define DATASTART  (BMAPSTART + NBITMAPBLOCKS)
#define NDATABLOCKS (NBLOCKS - DATASTART)
#define FSSIZE       2000
